package opensteam.bigpictureremote.Discovery.net;
...
public class DiscoveryClient implements Runnable {
    ...
    public static interface ResponseListener {
        public void onResponse(InetSocketAddress address, CMsgRemoteClientBroadcastHeader header, CMsgRemoteClientBroadcastStatus status);
    ...
    private void handlePacket(DatagramPacket packet) throws IOException {
        ...
        listener.onResponse((InetSocketAddress)packet.getSocketAddress(), header, message);
    }
    public static void main(String[] args) {
        DiscoveryClient client = new DiscoveryClient(12345678, new ResponseListener() {
            public void onResponse(InetSocketAddress address, CMsgRemoteClientBroadcastHeader header,
